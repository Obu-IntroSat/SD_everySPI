...
*/
#ifndef Sd2Card_everySPI_h
#define Sd2Card_everySPI_h
/**
   \file
   Sd2Card class
*/
#include "Sd2PinMap_everySPI.h"
#include "SdInfo_everySPI.h"
#include <SPI.h>
...
class Sd2Card {
  public:
    ...
    */
    uint8_t init(void) {
      return init(SPI_FULL_SPEED, SD_CHIP_SELECT_PIN, SPI);
    }
    /**
    ...
    */
    uint8_t init(uint8_t sckRateID) {
      return init(sckRateID, SD_CHIP_SELECT_PIN, SPI);
    }
    uint8_t init(uint8_t sckRateID, uint8_t chipSelectPin) {
	  return init(sckRateID, chipSelectPin, SPI);
	}
	uint8_t init(SPIClass &user_spi) {
	  return init(SPI_FULL_SPEED, SD_CHIP_SELECT_PIN, user_spi);
	}
	uint8_t init(uint8_t sckRateID, uint8_t chipSelectPin, SPIClass &user_spi);
